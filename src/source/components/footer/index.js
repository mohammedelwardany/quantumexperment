    ...
    >
      ...
      >
        ...
        <Col
          ...
          lg={4}
          xl={4}
          style={{ display: "flex", flexDirection: "column", fontSize: "2vh" }}
          className="alighmentScreens"
        >
          {" "}
          <h3 className="headerfooter">LET US HELP YOU</h3>
            ...
            <div>
              ...
              >
                ...
                <i
                  ...
                  style={{ fontSize: "3vh", marginInlineEnd: "1vh" }}
                ></i>
                Info@quantumme.net{" "}
              </Space>
        ...
        <Col
          ...
          className="alighmentScreens"
        >
          <h3 className="headerfooter">VISIT QUANTUM</h3>

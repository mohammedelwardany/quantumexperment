  ...
  return (
    ...
    <Footer style={{ textAlign: 'start', backgroundColor: "#000", color: "#fff" }}>
      ...
      <Row  style={{display:"flex",justifyContent:"start"}} className='alighmentScreens'>
        ...
        <Col sm={24} md={24} lg={4} xl={4}></Col>
        <Col sm={24} md={24} lg={4} xl={4} style={{display:"flex",flexDirection:"column",fontSize:"2vh"}} className='alighmentScreens'>  <h3 className='headerfooter'>LET US HELP YOU</h3>
        ...
        <Col sm={24} md={24} lg={4} xl={4}></Col>
        <Col sm={24} md={24} lg={4} xl={4} style={{display:"flex",flexDirection:"column",fontSize:"2vh"}} className='alighmentScreens'><h3 className='headerfooter'>VISIT QUANTUM</h3>
